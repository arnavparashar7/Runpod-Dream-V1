...
RUN comfy model download --url https://huggingface.co/Shakker-Labs/FLUX.1-dev-ControlNet-Union-Pro-2.0/blob/main/diffusion_pytorch_model.safetensors --relative-path models/controlnet --filename FLUX.1-dev-ControlNet-Union-Pro-2.0.safetensors
